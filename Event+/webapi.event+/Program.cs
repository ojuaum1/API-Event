...
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    ...
    new ApiKeyServiceClientCredentials("d5ac0b4fa33742a0b6283e07c69912a6")) //o valor entre parenteses é a credencial individual de cada um.
{
    //EndPoint Disponivel Pelo Azure
    Endpoint = "https://eventplusmoderator-joao.cognitiveservices.azure.com/"
});
